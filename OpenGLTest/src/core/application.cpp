...
namespace Core
{
	...
	void Application::run()
	{
        ...
        Shader* cubeShader = new Shader("res/shaders/basic-material.glsl");
        cubeShader->set();
        ...
        RenderableObject* cubeRender = new RenderableObject(cubeShader, cubePrimitive.getVao(), cubeTextures, 36);
        ...
        Shader* lightShader = new Shader("res/shaders/light.glsl");
        lightShader->set();
        lightShader->setUniformMat4("projection", projection);

        RenderableObject* lightRender = new RenderableObject(lightShader, cubePrimitive.getVao(), nullptr, 36);
		...
		while (this->_running) {
            ...
            cubeShader->set();
            cubeShader->setUniformVec3("light.position", newLightPosition);
            cubeShader->unset();
